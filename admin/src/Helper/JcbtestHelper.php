...
/**
 * Jcbtest component helper.
 *
 * @since   3.0
 */
abstract class JcbtestHelper
{
	/**
	 * Composer Switch
	 *
	...
	{
		$manifestUrl = JPATH_ADMINISTRATOR."/components/com_jcbtest/jcbtest.xml";
	...
	{
		// get params
		$params    = ComponentHelper::getParams('com_jcbtest');
	...
	public static function addSubmenu($submenu)
	{
		...
		\JHtmlSidebar::addEntry(Text::_('COM_JCBTEST_SUBMENU_DASHBOARD'), 'index.php?option=com_jcbtest&view=jcbtest', $submenu === 'jcbtest');
		if ($user->authorise('test.access', 'com_jcbtest') && $user->authorise('test.submenu', 'com_jcbtest'))
		{
			\JHtmlSidebar::addEntry(Text::_('COM_JCBTEST_SUBMENU_TESTS'), 'index.php?option=com_jcbtest&view=tests', $submenu === 'tests');
		}
	}
	...
	*/
	public static function xls($rows, $fileName = null, $title = null, $subjectTab = null, $creator = 'Alizarina', $description = null, $category = null,$keywords = null, $modified = null)
	{
		// set the user
	...
	*/
	 ...
	 */
	public static function getVar($table, $where = null, $whereString = 'user', $what = 'id', $operator = '=', $main = 'jcbtest')
	{
	 ...
	 */
	public static function getVars($table, $where = null, $whereString = 'user', $what = 'id', $operator = 'IN', $main = 'jcbtest', $unique = true)
	{
	...
	public static function isPublished($id,$type)
	{
		...
		$query->from('#__jcbtest_'.$type.' AS a');
	 ...
	 *
	 */
	public static function getActions($view, &$record = null, $views = null, $target = null, $component = 'jcbtest', $user = 'null')
	{
	...
	public static function getModel(string $type, string $prefix = 'Administrator',
		string $component = 'jcbtest', array $config = [])
	{
	...
	public static function setAsset($id, $table, $inherit = true)
	{
		...
		$parent->loadByName('com_jcbtest');

		$parentId = $parent->id;
		$name     = 'com_jcbtest.'.$table.'.'.$id;
		$title    = '';
		...
		else
		{
			...
			$rules = self::getDefaultAssetRules('com_jcbtest', $table, $inherit);
			...
			else
			{
				...
				return Factory::getDbo()->updateObject('#__jcbtest_'.$table, $object, 'id');
			}
		}
		return false;
	}
